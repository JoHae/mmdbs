...
public class LCHOptions extends JPanel {
    ...
    */
   public LCHOptions() {
      setBorder(new TitledBorder(null, "Local Color Histogram Options", TitledBorder.LEADING, TitledBorder.TOP, null, null));
      ...
      JLabel lblNumberOfBins = new JLabel("Number of Cells:");
